...
src_train = r"D:/NCT/NCT-2/S2/Capston/DataSets/COCO/train2017"

# Destination folder for the subset
dst_train = r"D:/NCT/NCT-2/S2/Capston/DataSets/COCO/COCO_small/train2017"

# Create the destination folder if it doesn't exist
os.makedirs(dst_train, exist_ok=True)

# Subset ratio (60% of the data)
subset_ratio = 0.6
...
print("Subset (60%) created successfully!")
